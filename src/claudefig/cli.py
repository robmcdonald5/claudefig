...
from claudefig.cli_decorators import handle_errors, with_config
...
@handle_errors(
    ...
    extra_handlers={
        ...
        PresetExistsError: lambda e: console.print(format_cli_error(str(e))),
    },
)
...
@handle_errors("listing templates")
...
@handle_errors("showing template")
